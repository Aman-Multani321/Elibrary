<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AdminBookinventry.aspx.cs" Inherits="ElaibraryManagement.AdminBookinventry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <div class="col">
      <center>
         <img id="imgview" height="150px" width="150px" src="Bookinventry/books1.png" />
      </center>
   </div>
</div>
<div class="row">
   ...
   <div class="col">
      <asp:FileUpload onchange="readURL(this);" class="form-control" ID="FileUpload1" runat="server" />
                  ...
                  <div class="row">
                     ...
                     <div class="col-4">
                        <asp:Button ID="Button2" class="btn btn-lg btn-block btn-danger" runat="server" Text="Delete" OnClick="Button3_Click" />
                     </div>
                  </div>
               </div>
            </div>
