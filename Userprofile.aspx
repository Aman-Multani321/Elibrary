<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Userprofile.aspx.cs" Inherits="ElaibraryManagement.Userprofile" %>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col text-center">
                                <img width="100px" src="imaes/generaluser.png" alt="User Profile"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col text-center">
                                ...
                                <asp:Label CssClass="badge bg-info text-dark" ID="Label1" runat="server" Text="Your status"></asp:Label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
            ...
            <div class="col-md-7">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col text-center">
                                <img width="100px" src="imaes/books1.png" alt="Issued Books"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col text-center">
                                <h4>Your Issued Books</h4>
                                <asp:Label CssClass="badge bg-info text-dark" ID="Label2" runat="server" Text="Your total books"></asp:Label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <asp:GridView CssClass="table table-bordered" ID="GridView1" runat="server">
                                </asp:GridView>
                            </div>
                        </div>
                    </div>
