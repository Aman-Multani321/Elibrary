<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AdminPublishermanagment.aspx.cs" Inherits="ElaibraryManagement.AdminPublishermanagment" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img width="100px" src="imaes/publisher.png" />
                                </center>
                            </div>
                        </div>
                        <div class="row">
            ...
            <div class="col-md-7">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:con %>" SelectCommand="SELECT [publisher_id], [publisher_name] FROM [publisher_master_tbl]"></asp:SqlDataSource>
                              <div class="col">
